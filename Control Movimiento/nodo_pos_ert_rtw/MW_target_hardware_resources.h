...
#define MW_BOARDPARAMETERS_DEVICEADDRESS 172.31.28.38
#define MW_BOARDPARAMETERS_USERNAME turtlebot
#define MW_RUNTIME_BUILDACTION 1
#define MW_ROS_INSTALL /opt/ros/groovy
#define MW_ROS_CATKINWS ~/catkin_ws_simulink
